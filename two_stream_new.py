...
def create_model():
	...
	auxiliary_input= Input(shape=(timesteps,data_dim), name='auxiliary_input')
	...
	y= LSTM(128,activation='relu', dropout=0.2, return_sequences=True)(auxiliary_input)
	y= LSTM(128,activation='relu', dropout=0.2)(y)
	y= Dense(64, activation='relu')(y)
	y= Dense(32, activation='relu')(y)

	merged_vector= concatenate([x,y], axis=-1)
...
#print(model.summary())
history=model.fit({'main_input':input_to_lstm_1, 'auxiliary_input': input_to_lstm_2}, texture_label,
	 validation_split= 0.2, batch_size =32, epochs= 100, shuffle= True)
