...
## Given videos, it extracts frames, pass each frame through resnet and get  sequence of features for the video
def extract_frame():
	frate=24
	delay= int(1000/24)
	...
	## For optical path, uncomment this
	...
	#files=os.listdir(path)
	#print(files)
	video_file_path= "Videoopticalvectors"
...
if not os.path.exists("Videovectors"):
	os.makedirs("Videovectors")
